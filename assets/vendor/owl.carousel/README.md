...
```html
<link rel="stylesheet" href="/node_modules/owl.carousel/dist/{% static 'owl.carousel.min.css" />
```

```html
<link rel="stylesheet" href="/bower_components/owl.carousel/dist/{% static 'owl.carousel.min.css" />
```
